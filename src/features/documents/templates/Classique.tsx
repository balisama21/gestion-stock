 ...
 * permettra d'avoir quatre modèles sans vérifier quatre fois que le
 * reste dû est le bon.
 *
 ...
 */
export const Classique: React.FC<{ document: Document }> = ({ document: d }) => (
  <div className="doc-pad doc-grow">
    ...
    <TableauLignes lignes={d.lignes} devise={d.devise} />

    {/* Le montant en lettres et les mentions à gauche, les totaux à
        droite. Le tout reste insécable : un total seul en haut d'une
        page fait douter du document entier. */}
    ...
    {/* Pousse le pied de page en bas de la feuille, quelle que soit
        la longueur du tableau. C'est ce qui donne à une facture d'une
        ligne la même allure qu'à une facture de quinze. */}
